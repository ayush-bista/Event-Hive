...
public class StudentContactServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        req.getRequestDispatcher("/WEB-INF/views/student/contact.jsp").forward(req, res);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (contactDAO.saveMessage(msg)) {
                req.setAttribute("success", "Thank you! Your message has been sent. We will get back to you soon.");
            } else {
